...
describe('normalizeMoveArguments', () => {
	it('should handle resolved myso objects for `object` args', async () => {
  ...
  "commands": [
	...
	it('should handle resolved myso objects for `object` args with extra trailing args', async () => {
		const tx = new Transaction();
		tx.moveCall({
			target: '0x0::test:test',
			arguments: normalizeMoveArguments(
  ...
  "commands": [
	...
	it('should handle resolved myso objects for `Array` args', async () => {
		const tx = new Transaction();
		tx.moveCall({
			target: '0x0::test:test',
			arguments: normalizeMoveArguments(
  ...
  "commands": [
	...
	it('should handle resolved myso objects for `Array` args with extra trailing args', async () => {
		const tx = new Transaction();
