...
export const Auditors = new MoveStruct({ name: `${$moduleName}::Auditors`, fields: {
        pks: bcs.vector(group_ops.Element),
        version: bcs.u32(),
        recommended_min_version: bcs.u32()
    } });
export const VerifiedKeyEncryption = new MoveStruct({ name: `${$moduleName}::VerifiedKeyEncryption`, fields: {
        ciphertext: bcs.vector(twisted_elgamal.MultiRecipientEncryption),
        version: bcs.u32()
    } });
export const KeyEncryption = new MoveStruct({ name: `${$moduleName}::KeyEncryption`, fields: {
        ciphertext: bcs.vector(twisted_elgamal.MultiRecipientEncryption),
...
export interface NewKeyEncryptionOptions {
    package?: string;
    arguments: NewKeyEncryptionArguments | [
        ciphertext: RawTransactionArgument<string[]>,
        proof: RawTransactionArgument<string>,
        rangeProof: RawTransactionArgument<number[]>
    ];
