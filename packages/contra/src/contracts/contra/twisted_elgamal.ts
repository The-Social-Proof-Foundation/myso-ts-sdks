...
export interface MultiRecipientCiphertextOptions {
	package?: string;
	arguments: MultiRecipientCiphertextArguments | [e: RawTransactionArgument<string>];
}
/**
...
export interface MultiRecipientDecryptionHandlesOptions {
	package?: string;
	arguments: MultiRecipientDecryptionHandlesArguments | [e: RawTransactionArgument<string>];
}
/**
