...
- [`@socialproof/dapp-kit-react`](https://sdk.mystenlabs.com/dapp-kit) for connecting
  to wallets and loading data
- [`@socialproof/codegen`](https://sdk.mystenlabs.com/codegen) for generating
...
Before deploying your move code, ensure that you have installed the MySo CLI. You
can follow the [MySo installation instruction](https://docs.mysocial.network/build/install)
...
If you haven't set up an address in the myso client yet, you can use the
...
```bash
myso client switch --address 0xYOUR_ADDRESS...
```

We can ensure we have some MySo in our new wallet by requesting MySo from the
faucet `https://faucet.mysocial.network`.

### Publishing the move package

The move code for this template is located in the `move` directory. To publish
it, you can enter the `move` directory, and publish it with the MySo CLI:

```bash
cd move
myso client publish --gas-budget 100000000 counter
```
