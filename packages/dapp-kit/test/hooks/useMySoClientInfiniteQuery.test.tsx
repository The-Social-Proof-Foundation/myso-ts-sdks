...
import { useMySoClientInfiniteQuery } from '../../src/hooks/useMySoClientInfiniteQuery.js';
import { createWalletProviderContextWrapper } from '../test-utils.js';

describe('useMySoClientInfiniteQuery', () => {
	it('should fetch data', async () => {
		...
		const { result } = renderHook(
			() =>
				useMySoClientInfiniteQuery('queryTransactionBlocks', {
					filter: {
						FromAddress: '0x123',
					},
				}),
