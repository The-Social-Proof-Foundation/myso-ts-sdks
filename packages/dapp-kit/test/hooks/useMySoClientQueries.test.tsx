...
import { useMySoClientQueries } from '../../src/hooks/useMySoClientQueries.js';
...
describe('useMySoClientQueries', () => {
	...
	test('should fetch data', async () => {
		const getAllBalances = vi.spyOn(mysoClient, 'getAllBalances');
