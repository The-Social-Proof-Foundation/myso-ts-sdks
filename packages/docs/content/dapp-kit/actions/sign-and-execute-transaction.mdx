...
a transaction on the MySo network. This is the most common way to execute transactions in your dApp.
...
- The action transparently handles both `myso:signAndExecuteTransaction` and
  `myso:signAndExecuteTransactionBlock` wallet-standard features
