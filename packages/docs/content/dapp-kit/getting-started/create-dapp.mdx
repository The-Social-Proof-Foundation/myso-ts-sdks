...
description: Create a MySo dApp with one command
---

`@socialproof/create-dapp` is a CLI tool that scaffolds a complete MySo dApp project with best practices
built in.
...
- TypeScript bindings generated with `@socialproof/codegen`
...
- [`@socialproof/dapp-kit-react`](/dapp-kit) - Wallet connection and blockchain interaction
- [pnpm](https://pnpm.io/) - Package management

The e2e-counter template also includes:

- [`@socialproof/codegen`](/codegen) - Generate TypeScript from Move code
...
First, install the [MySo CLI](https://docs.mysocial.network/build/install) and set up testnet:
...
Get testnet MYSO from the [faucet](https://faucet.mysocial.network), then publish:
...
npm create @socialproof/dapp -- -t react-e2e-counter

# Create with specific name
npm create @socialproof/dapp -- -n my-app

# Create with both
npm create @socialproof/dapp -- -t react-client-dapp -n my-app
```
