...
```tsx
import { useCurrentAccount, useCurrentWallet, useCurrentNetwork } from '@socialproof/dapp-kit-react';
...
```tsx
import { useDAppKit, useCurrentAccount } from '@socialproof/dapp-kit-react';
import { Transaction, coinWithBalance } from '@socialproof/myso/transactions';
...
| [useCurrentClient](/dapp-kit/react/hooks/use-current-client)       | MySoClient for current network            |
