...
```tsx
import { createDAppKit, DAppKitProvider } from '@socialproof/dapp-kit-react';
...
```tsx
import type { UiWallet } from '@socialproof/dapp-kit-react';
import { useDAppKit, useCurrentAccount, useCurrentNetwork } from '@socialproof/dapp-kit-react';
