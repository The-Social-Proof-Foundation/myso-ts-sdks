...
```txt
## MySo TypeScript SDK v2 Migration

Migrate this codebase to the latest version of `@socialproof/*` packages.
...
https://sdk.mystenlabs.com/myso/migrations/myso-2.0/llms.txt

This file contains the migration instructions for most affected @socialproof package, but please be sure to install the
latest version of all @socialproof packages even if they do not have an explicit migration guide
