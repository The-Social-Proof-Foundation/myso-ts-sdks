...
[TransactionDataBuilder](/typedoc/classes/_mysten_myso.transactions.TransactionDataBuilder.html)
...
properties in the
[typedoc definition](/typedoc/classes/_mysten_myso.transactions.TransactionDataBuilder.html).
...
```typescript
import { Commands, Transaction } from '@socialproof/myso/transactions';
...
```typescript
import { Commands, Transaction, TransactionObjectInput } from '@socialproof/myso/transactions';
