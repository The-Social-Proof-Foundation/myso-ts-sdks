---
title: Paying for MySo Transactions with Gas Coins
---

With Programmable Transactions, you can use the gas payment coin to construct coins with a set
balance using `splitCoin`. This is useful for MySo payments, and avoids the need for up-front coin
...
[by-reference](https://docs.mysocial.network/guides/developer/myso-101/simulating-refs). Practically speaking,
...
**Note:** The gas budget is represented in MySo, and should take the gas price of the transaction
into account.
