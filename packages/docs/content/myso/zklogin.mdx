...
```typescript
import { getZkLoginSignature } from '@socialproof/myso/zklogin';
...
```typescript
import { computeZkLoginAddressFromSeed } from '@socialproof/myso/zklogin';
...
```typescript
import { computeZkLoginAddress } from '@socialproof/myso/zklogin';
...
To use zkLogin inside a multisig, see the [Multisig Guide](../myso/cryptography/multisig) for more
details.
