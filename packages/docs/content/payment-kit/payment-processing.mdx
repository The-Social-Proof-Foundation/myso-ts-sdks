...
const paymentParams = {
	...
	coinType: '0x2::myso::MYSO', // MYSO token
	amount: 1000000000, // 1 MYSO (in MIST)
	receiver,
...
if (receiptEvent) {
	...
	console.log('  Amount:', receipt.amount); // 1n * MIST_PER_MYSO
	console.log('  Receiver:', receipt.receiver); //
	console.log('  Coin Type:', receipt.coin_type); // '0x2::myso::MYSO'
...
Payment Kit works with any MySo coin type:
