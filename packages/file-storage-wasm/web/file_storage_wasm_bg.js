...
export class BlobEncoder {
    ...
    /**
     * WASM wrapper for [file-storage_core::encoding::blob_encoding::BlobEncoder::encode_with_metadata].
     * Returns a tuple with a vector of [file-storage_core::encoding::slivers::SliverPair]´s and a [file-storage_core::metadata::VerifiedBlobMetadataWithId]`.
    ...
    /**
     * WASM wrapper for [file-storage_core::encoding::blob_encoding::BlobEncoder::compute_metadata].
     * Returns [file-storage_core::metadata::VerifiedBlobMetadataWithId].
     * @param {Uint8Array} data
     * @returns {any}
     */
    ...
    /**
     * WASM wrapper for [file-storage_core::encoding::blob_encoding::BlobEncoder::decode].
