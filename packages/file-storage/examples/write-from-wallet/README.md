# File Storage Write from Wallet Example

This example demonstrates how to use the File Storage SDK to upload files from a wallet.
...
- Encodes the file using file-storage
