...
import type { FileStoragePackageConfig } from './types.js';

export const TESTNET_FILE_STORAGE_PACKAGE_CONFIG = {
...
} satisfies FileStoragePackageConfig;

export const MAINNET_FILE_STORAGE_PACKAGE_CONFIG = {
