...
import * as object_table from './deps/myso/object_table.js';
import * as extended_field from './extended_field.js';
import * as committee from './committee.js';
import * as epoch_parameters from './epoch_parameters.js';
const $moduleName = '@local-pkg/file-storage::staking_inner';
/** The epoch state. */
...
export const StakingInnerV1 = new MoveStruct({
	...
	fields: {
		...
		/**
		 * The current epoch of the File Storage system. The epochs are not the same as the MySo
