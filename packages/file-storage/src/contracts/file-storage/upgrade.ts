...
/**
 * Module to manage File Storage contract upgrades.
 *
...
const $moduleName = '@local-pkg/file-storage::upgrade';
 ...
 *
 * This should be used sparingly and once file-storage has a healthy community and
