...
export class StorageNodeClient {
	...
	/**
	 * Gets the metadata associated with a File Storage blob.
	 */
	...
	/**
	 * Gets the status associated with a File Storage blob.
	 */
	async getBlobStatus(
	...
	/**
	 * Stores the metadata associated with a registered File Storage blob at this storage
	 * node. This is a pre-requisite for storing the encoded slivers of the blob. The
	 * ID of the blob must first be registered on MySo, after which storing the metadata
	 * becomes possible.
	 *
