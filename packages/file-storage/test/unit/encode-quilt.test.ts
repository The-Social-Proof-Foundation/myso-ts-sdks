...
import type { FileStorageClient } from '../../src/client.js';
...
// Create a configurable mock FileStorageClient for testing with call tracking.
...
function createMockClient({
	...
	const client = {
		...
		async getSecondarySliver({ index }: { index: number }) {
			...
			// Map secondary sliver index to sliver pair index (same mapping as FileStorageClient)
