 ...
 *
 * @example
 * import MySo from "@socialproof/ledgerjs-hw-app-myso";
 * const myso = new MySo(transport)
 */
export default class MySo {
	transport: Transport;
	readonly #verbose: boolean;

	constructor(transport: Transport, scrambleKey = 'default_myso_scramble_key', verbose = false) {
