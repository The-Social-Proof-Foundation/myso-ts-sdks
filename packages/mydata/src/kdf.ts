 ...
 */
const DST: Uint8Array = new TextEncoder().encode('MYSO-MYDATA-IBE-BLS12381-00');
const KDF_DST = new TextEncoder().encode('MYSO-MYDATA-IBE-BLS12381-H2-00');
const DERIVE_KEY_DST = new TextEncoder().encode('MYSO-MYDATA-IBE-BLS12381-H3-00');
...
export function kdf(
	...
	if (objectIdBytes.length !== MYSO_ADDRESS_LENGTH) {
...
export function deriveKey(
	...
	if (keyServerBytes.some((keyServer) => keyServer.length !== MYSO_ADDRESS_LENGTH)) {
