...
describe('MyData encryption tests', () => {
	...
	it('Rust test vector decryption', async () => {
		// Test created with mydata-cli using the command:
		...
		// Created with cargo run --bin mydata-cli extract --package-id 0x0 --id 0x381dd9078c322a4663c392761a0211b527c127b29583851217f948d62131f409 --master-key 1aa66668afc1893b66eb5ad690b14b32b41797dd92f7220b11f7441b11d22bfb
		...
		// Created with cargo run --bin mydata-cli extract --package-id 0x0 --id 0x381dd9078c322a4663c392761a0211b527c127b29583851217f948d62131f409 --master-key 0740419bedd2fdfb036f468a99d95d2f37ad66eb3111b815ca19ec001c35388a
	...
	it('check share consistency', async () => {
		...
		// Generated using this Rust unit test: https://github.com/MystenLabs/mydata/blob/828e0e90ea0282c59836c4d9cb7ec9e9f47d5d3a/crates/crypto/src/lib.rs#L668-L725
