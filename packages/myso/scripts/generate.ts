...
const res = await fetch(
	'https://raw.githubusercontent.com/the-social-proof-foundation/myso-core/refs/heads/main/crates/myso-open-rpc/spec/openrpc.json',
);
...
const options: {
	...
	types: {
		...
		Data: { alias: 'MySoParsedData' },
		Event: { alias: 'MySoEvent' },
		EventFilter: { alias: 'MySoEventFilter' },
		EventID: { alias: 'EventId' },
		GasData: { alias: 'MySoGasData' },
		MoveFunctionArgType: { alias: 'MySoMoveFunctionArgType' },
		ObjectChange: { alias: 'MySoObjectChange' },
		ObjectData: { alias: 'MySoObjectData' },
		ObjectDataOptions: { alias: 'MySoObjectDataOptions' },
		ObjectRef: { alias: 'MySoObjectRef' },
		ObjectResponseQuery: { alias: 'MySoObjectResponseQuery' },
		Owner: { alias: 'ObjectOwner' },
		PaginatedMySoObjectResponse: { alias: 'PaginatedObjectsResponse' },
		PaginatedTransactionBlockResponse: { alias: 'PaginatedTransactionResponse' },
		Stake: { alias: 'StakeObject' },
		MySoCoinMetadata: { alias: 'CoinMetadata' },
		MySoProgrammableMoveCall: { alias: 'MoveCallMySoTransaction' },
		Supply: { alias: 'CoinSupply' },
		TransactionBlock: { alias: 'MySoTransactionBlock' },
		TransactionBlockEffects: { alias: 'TransactionEffects' },
		TransactionBlockKind: { alias: 'MySoTransactionBlockKind' },
		TransactionBlockResponse: { alias: 'MySoTransactionBlockResponse' },
		TransactionBlockResponseOptions: { alias: 'MySoTransactionBlockResponseOptions' },
		TransactionBlockResponseQuery: { alias: 'MySoTransactionBlockResponseQuery' },
...
export function normalizeMethodName(name: string): string {
	if (name.startsWith('myso_')) {
		return normalizeMethodName(name.slice(4));
	}

	if (name.startsWith('mysox_')) {
