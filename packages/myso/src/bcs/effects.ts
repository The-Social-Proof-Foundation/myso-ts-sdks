...
import { Address, ObjectDigest, Owner, MySoObjectRef, TypeTag } from './bcs.js';

// Rust: crates/myso-types/src/execution_status.rs (PackageUpgradeError enum)
...
// Rust: crates/myso-types/src/execution_status.rs
...
const ExecutionFailureStatus = bcs.enum('ExecutionFailureStatus', {
	...
	MySoMoveVerificationError: null,
	...
	MySoMoveVerificationTimedout: null,
	SharedObjectOperationNotAllowed: null,
...
// Rust: crates/myso-types/src/gas.rs
...
// Rust: crates/myso-types/src/effects/effects_v1.rs
const TransactionEffectsV1 = bcs.struct('TransactionEffectsV1', {
	status: ExecutionStatus,
	executedEpoch: bcs.u64(),
	gasUsed: GasCostSummary,
	modifiedAtVersions: bcs.vector(bcs.tuple([Address, bcs.u64()])),
	sharedObjects: bcs.vector(MySoObjectRef),
	transactionDigest: ObjectDigest,
	created: bcs.vector(bcs.tuple([MySoObjectRef, Owner])),
	mutated: bcs.vector(bcs.tuple([MySoObjectRef, Owner])),
	unwrapped: bcs.vector(bcs.tuple([MySoObjectRef, Owner])),
	deleted: bcs.vector(MySoObjectRef),
	unwrappedThenDeleted: bcs.vector(MySoObjectRef),
	wrapped: bcs.vector(MySoObjectRef),
	gasObject: bcs.tuple([MySoObjectRef, Owner]),
	eventsDigest: bcs.option(ObjectDigest),
	dependencies: bcs.vector(ObjectDigest),
});

// Rust: crates/myso-types/src/base_types.rs
const VersionDigest = bcs.tuple([bcs.u64(), ObjectDigest]);

// Rust: crates/myso-types/src/effects/object_change.rs
...
// Rust: crates/myso-types/src/effects/mod.rs
...
// Rust: crates/myso-types/src/effects/effects_v2.rs
