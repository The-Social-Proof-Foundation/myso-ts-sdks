...
import type { Transaction as GrpcTransaction } from '../grpc/proto/myso/rpc/v2/transaction.js';
import {
	Transaction as GrpcTransactionType,
	TransactionExpiration_TransactionExpirationKind,
} from '../grpc/proto/myso/rpc/v2/transaction.js';
import type { ObjectReference } from '../grpc/proto/myso/rpc/v2/object_reference.js';
import type { Input } from '../grpc/proto/myso/rpc/v2/input.js';
import { FundsWithdrawal_Source, Input_InputKind } from '../grpc/proto/myso/rpc/v2/input.js';
import type { Command } from '../grpc/proto/myso/rpc/v2/transaction.js';
import type { Argument } from '../grpc/proto/myso/rpc/v2/argument.js';
import { Argument_ArgumentKind } from '../grpc/proto/myso/rpc/v2/argument.js';
...
/**
 * Converts an array of ObjectReferences from gRPC format to TypeScript MySoObjectRef format
 */
			...
			return {
				...
				FundsWithdrawal: {
					...
					typeArg: {
						...
						Balance: input.fundsWithdrawal?.coinType ?? '0x2::myso::MYSO',
					},
					withdrawFrom:
