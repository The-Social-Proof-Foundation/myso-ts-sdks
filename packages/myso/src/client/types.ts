...
import type { EnumOutputShape } from '@socialproof/bcs';
import type {
...
export type MySoClientRegistration<
...
export namespace MySoClientTypes {
	export type Network = 'mainnet' | 'testnet' | 'devnet' | 'localnet' | (string & {});

	export interface MySoClientOptions {
		network: Network;
		base?: BaseClient;
		cache?: ClientCache;
	}
