...
export type ConsensusObjectCancelled = {
  ...
  address?: Maybe<Scalars['MySoAddress']['output']>;
...
export type EventFilter = {
  ...
  sender?: InputMaybe<Scalars['MySoAddress']['input']>;
  /**
...
export type Linkage = {
  ...
  originalId?: Maybe<Scalars['MySoAddress']['output']>;
  /** The ID on-chain of the version of the dependency that this package depends on. */
  upgradedId?: Maybe<Scalars['MySoAddress']['output']>;
...
export type PublishCommand = {
  ...
  dependencies?: Maybe<Array<Scalars['MySoAddress']['output']>>;
...
export type QueryVerifyZkLoginSignatureArgs = {
  author: Scalars['MySoAddress']['input'];
...
export type TransactionFilter = {
   ...
   */
  affectedAddress?: InputMaybe<Scalars['MySoAddress']['input']>;
  /**
   ...
   */
  affectedObject?: InputMaybe<Scalars['MySoAddress']['input']>;
  ...
  sentAddress?: InputMaybe<Scalars['MySoAddress']['input']>;
};
...
export type TypeOrigin = {
  ...
  definingId?: Maybe<Scalars['MySoAddress']['output']>;
...
export type UpgradeCommand = {
  ...
  currentPackage?: Maybe<Scalars['MySoAddress']['output']>;
  /** IDs of the transitive dependencies of the package to be published. */
  dependencies?: Maybe<Array<Scalars['MySoAddress']['output']>>;
  /** Bytecode for the modules to be published, BCS serialized and Base64 encoded. */
  modules?: Maybe<Array<Scalars['Base64']['output']>>;
...
export type GetDynamicFieldsQueryVariables = Exact<{
  parentId: Scalars['MySoAddress']['input'];
  first?: InputMaybe<Scalars['Int']['input']>;
  cursor?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type GetMoveFunctionQueryVariables = Exact<{
  package: Scalars['MySoAddress']['input'];
...
export const GetAllBalancesDocument = new TypedDocumentString(`
    query getAllBalances($owner: MySoAddress!, $limit: Int, $cursor: String) {
...
export const GetBalanceDocument = new TypedDocumentString(`
    query getBalance($owner: MySoAddress!, $coinType: String = "0x2::myso::MYSO") {
  address(address: $owner) {
...
export const GetCoinsDocument = new TypedDocumentString(`
    query getCoins($owner: MySoAddress!, $first: Int, $cursor: String, $type: String = "0x2::coin::Coin<0x2::myso::MYSO>") {
  address(address: $owner) {
    address
...
export const GetDynamicFieldsDocument = new TypedDocumentString(`
    query getDynamicFields($parentId: MySoAddress!, $first: Int, $cursor: String) {
...
export const GetMoveFunctionDocument = new TypedDocumentString(`
    query getMoveFunction($package: MySoAddress!, $module: String!, $function: String!) {
...
export const VerifyZkLoginSignatureDocument = new TypedDocumentString(`
    query verifyZkLoginSignature($bytes: Base64!, $signature: Base64!, $intentScope: ZkLoginIntentScope!, $author: MySoAddress!) {
