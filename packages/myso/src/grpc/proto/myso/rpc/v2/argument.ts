...
// @generated from protobuf file "myso/rpc/v2/argument.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Argument
 */
export interface Argument {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Argument.ArgumentKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.Argument.ArgumentKind
 */
...
class Argument$Type extends MessageType<Argument> {
	constructor() {
		super('myso.rpc.v2.Argument', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.Argument.ArgumentKind', Argument_ArgumentKind],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Argument
 */
