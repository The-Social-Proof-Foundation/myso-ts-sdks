...
// @generated from protobuf file "myso/rpc/v2/checkpoint_contents.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CheckpointContents
 */
export interface CheckpointContents {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.CheckpointedTransactionInfo transactions = 4;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CheckpointedTransactionInfo
 */
export interface CheckpointedTransactionInfo {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.UserSignature signatures = 3;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.AddressAliasesVersion address_aliases_versions = 4;
	 */
	addressAliasesVersions: AddressAliasesVersion[];
}
/**
 * @generated from protobuf message myso.rpc.v2.AddressAliasesVersion
 */
...
class CheckpointContents$Type extends MessageType<CheckpointContents> {
	constructor() {
		super('myso.rpc.v2.CheckpointContents', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CheckpointContents
 */
...
class CheckpointedTransactionInfo$Type extends MessageType<CheckpointedTransactionInfo> {
	constructor() {
		super('myso.rpc.v2.CheckpointedTransactionInfo', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CheckpointedTransactionInfo
 */
...
class AddressAliasesVersion$Type extends MessageType<AddressAliasesVersion> {
	constructor() {
		super('myso.rpc.v2.AddressAliasesVersion', [
			{
				no: 1,
				name: 'version',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.AddressAliasesVersion
 */
