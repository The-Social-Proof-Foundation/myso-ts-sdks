...
// @generated from protobuf file "myso/rpc/v2/checkpoint_summary.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CheckpointSummary
 */
export interface CheckpointSummary {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.GasCostSummary epoch_rolling_gas_cost_summary = 8;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.CheckpointCommitment commitments = 10;
	 */
	commitments: CheckpointCommitment[];
	/**
	 * Extra data only present in the final checkpoint of an epoch.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.EndOfEpochData end_of_epoch_data = 11;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.EndOfEpochData
 */
export interface EndOfEpochData {
	/**
	 * The set of validators that will be in the `ValidatorCommittee` for the next epoch.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.ValidatorCommitteeMember next_epoch_committee = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.CheckpointCommitment epoch_commitments = 3;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CheckpointCommitment
 */
export interface CheckpointCommitment {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.CheckpointCommitment.CheckpointCommitmentKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.CheckpointCommitment.CheckpointCommitmentKind
 */
...
class CheckpointSummary$Type extends MessageType<CheckpointSummary> {
	constructor() {
		super('myso.rpc.v2.CheckpointSummary', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.EndOfEpochData
 */
...
class CheckpointCommitment$Type extends MessageType<CheckpointCommitment> {
	constructor() {
		super('myso.rpc.v2.CheckpointCommitment', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => [
					'myso.rpc.v2.CheckpointCommitment.CheckpointCommitmentKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CheckpointCommitment
 */
