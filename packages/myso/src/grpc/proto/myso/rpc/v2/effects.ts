...
// @generated from protobuf file "myso/rpc/v2/effects.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.TransactionEffects
 */
export interface TransactionEffects {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ExecutionStatus status = 4;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.GasCostSummary gas_used = 6;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ChangedObject gas_object = 8;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.ChangedObject changed_objects = 12;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.UnchangedConsensusObject unchanged_consensus_objects = 13;
	 */
	...
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.ObjectReference unchanged_loaded_runtime_objects = 15;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ChangedObject
 */
export interface ChangedObject {
	...
	objectId?: string;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ChangedObject.InputObjectState input_state = 2;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Owner input_owner = 5;
	 */
	inputOwner?: Owner;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ChangedObject.OutputObjectState output_state = 6;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Owner output_owner = 9;
	 */
	outputOwner?: Owner;
	/**
	 * The contents of the accumulator write when `output_state` is `OUTPUT_OBJECT_STATE_ACCUMULATOR_WRITE`
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.AccumulatorWrite accumulator_write = 12;
	 */
	accumulatorWrite?: AccumulatorWrite;
	/**
	 * What happened to an `ObjectId` during execution.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ChangedObject.IdOperation id_operation = 10;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.ChangedObject.InputObjectState
 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.ChangedObject.OutputObjectState
 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.ChangedObject.IdOperation
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.AccumulatorWrite
 */
export interface AccumulatorWrite {
	...
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.AccumulatorWrite.AccumulatorOperation operation = 3;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.AccumulatorWrite.AccumulatorOperation
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.UnchangedConsensusObject
 */
export interface UnchangedConsensusObject {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind
 */
...
class TransactionEffects$Type extends MessageType<TransactionEffects> {
	constructor() {
		super('myso.rpc.v2.TransactionEffects', [
	...
	constructor() {
		super('myso.rpc.v2.ChangedObject', [
			{ no: 1, name: 'object_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.ChangedObject.InputObjectState',
			...
			{ no: 5, name: 'input_owner', kind: 'message', T: () => Owner },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.ChangedObject.OutputObjectState',
			...
			{ no: 12, name: 'accumulator_write', kind: 'message', T: () => AccumulatorWrite },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.ChangedObject.IdOperation', ChangedObject_IdOperation],
			},
	...
	constructor() {
		super('myso.rpc.v2.AccumulatorWrite', [
			...
			{ no: 2, name: 'accumulator_type', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.AccumulatorWrite.AccumulatorOperation',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.AccumulatorWrite
 */
...
class UnchangedConsensusObject$Type extends MessageType<UnchangedConsensusObject> {
	constructor() {
		super('myso.rpc.v2.UnchangedConsensusObject', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => [
					'myso.rpc.v2.UnchangedConsensusObject.UnchangedConsensusObjectKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.UnchangedConsensusObject
 */
