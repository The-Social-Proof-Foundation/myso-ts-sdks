...
// @generated from protobuf file "myso/rpc/v2/event.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.TransactionEvents
 */
export interface TransactionEvents {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Event events = 3;
	 */
	events: Event[];
}
/**
 * An event.
 *
 * @generated from protobuf message myso.rpc.v2.Event
 */
export interface Event {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs contents = 5;
	 */
	contents?: Bcs;
	/**
...
class TransactionEvents$Type extends MessageType<TransactionEvents> {
	constructor() {
		super('myso.rpc.v2.TransactionEvents', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.TransactionEvents
 */
export const TransactionEvents = new TransactionEvents$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Event$Type extends MessageType<Event> {
	constructor() {
		super('myso.rpc.v2.Event', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Event
 */
