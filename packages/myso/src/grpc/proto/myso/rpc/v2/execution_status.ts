...
// @generated from protobuf file "myso/rpc/v2/execution_status.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ExecutionStatus
 */
export interface ExecutionStatus {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ExecutionError error = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ExecutionError
 */
export interface ExecutionError {
	...
	command?: bigint;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ExecutionError.ExecutionErrorKind kind = 3;
	 */
	...
	errorDetails:
		| {
				oneofKind: 'abort';
				/**
				 * @generated from protobuf field: myso.rpc.v2.MoveAbort abort = 4;
				 */
				abort: MoveAbort;
		  }
		| {
				oneofKind: 'sizeError';
				/**
				 * @generated from protobuf field: myso.rpc.v2.SizeError size_error = 5;
				 */
				sizeError: SizeError;
		  }
		| {
				...
				/**
				 * @generated from protobuf field: myso.rpc.v2.CommandArgumentError command_argument_error = 6;
				 */
		...
		| {
				...
				/**
				 * @generated from protobuf field: myso.rpc.v2.TypeArgumentError type_argument_error = 7;
				 */
		...
		| {
				...
				/**
				 * @generated from protobuf field: myso.rpc.v2.PackageUpgradeError package_upgrade_error = 8;
				 */
		...
		| {
				...
				/**
				 * @generated from protobuf field: myso.rpc.v2.IndexError index_error = 9;
				 */
		...
		| {
				...
				/**
				 * @generated from protobuf field: myso.rpc.v2.CoinDenyListError coin_deny_list_error = 11;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.CongestedObjects congested_objects = 12;
				 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.ExecutionError.ExecutionErrorKind
 */
export enum ExecutionError_ExecutionErrorKind {
	 ...
	 *
	 * @generated from protobuf enum value: MYSO_MOVE_VERIFICATION_ERROR = 11;
	 */
	MYSO_MOVE_VERIFICATION_ERROR = 11,
	/**
	 ...
	 *
	 * @generated from protobuf enum value: MYSO_MOVE_VERIFICATION_TIMEDOUT = 31;
	 */
	MYSO_MOVE_VERIFICATION_TIMEDOUT = 31,
	/**
...
/**
 * @generated from protobuf message myso.rpc.v2.MoveAbort
 */
export interface MoveAbort {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.MoveLocation location = 2;
	 */
	location?: MoveLocation;
	/**
	 * Extra error information if abort code is a "Clever Error"
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.CleverError clever_error = 3;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MoveLocation
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.CleverError
 */
 ...
 * A size error.
 *
 * @generated from protobuf message myso.rpc.v2.SizeError
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.IndexError
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.CoinDenyListError
 */
 ...
 * Set of objects that were congested, leading to the transaction's cancellation.
 *
 * @generated from protobuf message myso.rpc.v2.CongestedObjects
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CommandArgumentError
 */
export interface CommandArgumentError {
	...
	argument?: number;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.CommandArgumentError.CommandArgumentErrorKind kind = 2;
	 */
	kind?: CommandArgumentError_CommandArgumentErrorKind;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.IndexError index_error = 3;
	 */
	indexError?: IndexError;
}
/**
 * @generated from protobuf enum myso.rpc.v2.CommandArgumentError.CommandArgumentErrorKind
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.PackageUpgradeError
 */
export interface PackageUpgradeError {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.PackageUpgradeError.PackageUpgradeErrorKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.PackageUpgradeError.PackageUpgradeErrorKind
 */
 ...
 * Type argument error.
 *
 * @generated from protobuf message myso.rpc.v2.TypeArgumentError
 */
export interface TypeArgumentError {
	...
	typeArgument?: number;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.TypeArgumentError.TypeArgumentErrorKind kind = 2;
	 */
	kind?: TypeArgumentError_TypeArgumentErrorKind;
}
/**
 * @generated from protobuf enum myso.rpc.v2.TypeArgumentError.TypeArgumentErrorKind
 */
...
class ExecutionStatus$Type extends MessageType<ExecutionStatus> {
	constructor() {
		super('myso.rpc.v2.ExecutionStatus', [
	...
	constructor() {
		super('myso.rpc.v2.ExecutionError', [
			...
			},
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.ExecutionError.ExecutionErrorKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CoinDenyListError
 */
...
class CongestedObjects$Type extends MessageType<CongestedObjects> {
	constructor() {
		super('myso.rpc.v2.CongestedObjects', [
			{
				no: 1,
				name: 'objects',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CongestedObjects
 */
...
class CommandArgumentError$Type extends MessageType<CommandArgumentError> {
	constructor() {
		super('myso.rpc.v2.CommandArgumentError', [
			{ no: 1, name: 'argument', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.CommandArgumentError.CommandArgumentErrorKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CommandArgumentError
 */
...
class PackageUpgradeError$Type extends MessageType<PackageUpgradeError> {
	constructor() {
		super('myso.rpc.v2.PackageUpgradeError', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => [
					'myso.rpc.v2.PackageUpgradeError.PackageUpgradeErrorKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.PackageUpgradeError
 */
...
class TypeArgumentError$Type extends MessageType<TypeArgumentError> {
	constructor() {
		super('myso.rpc.v2.TypeArgumentError', [
			{ no: 1, name: 'type_argument', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.TypeArgumentError.TypeArgumentErrorKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.TypeArgumentError
 */
