...
// @generated from protobuf file "myso/rpc/v2/gas_cost_summary.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GasCostSummary
 */
...
class GasCostSummary$Type extends MessageType<GasCostSummary> {
	constructor() {
		super('myso.rpc.v2.GasCostSummary', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GasCostSummary
 */
