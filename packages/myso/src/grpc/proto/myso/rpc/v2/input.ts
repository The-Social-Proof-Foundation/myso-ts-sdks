...
// @generated from protobuf file "myso/rpc/v2/input.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Input
 */
export interface Input {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Input.InputKind kind = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Input.Mutability mutability = 7;
	 */
	mutability?: Input_Mutability;
	/**
	 * Fund Reservation information if `kind` is `FUNDS_WITHDRAWAL`.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.FundsWithdrawal funds_withdrawal = 8;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.Input.InputKind
 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.Input.Mutability
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.FundsWithdrawal
 */
export interface FundsWithdrawal {
	...
	coinType?: string;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.FundsWithdrawal.Source source = 3;
	 */
	source?: FundsWithdrawal_Source;
}
/**
 * @generated from protobuf enum myso.rpc.v2.FundsWithdrawal.Source
 */
...
class Input$Type extends MessageType<Input> {
	constructor() {
		super('myso.rpc.v2.Input', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.Input.InputKind', Input_InputKind],
			},
			...
			{ no: 6, name: 'mutable', kind: 'scalar', opt: true, T: 8 /*ScalarType.BOOL*/ },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.Input.Mutability', Input_Mutability],
			},
	...
	constructor() {
		super('myso.rpc.v2.FundsWithdrawal', [
			...
			{ no: 2, name: 'coin_type', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.FundsWithdrawal.Source', FundsWithdrawal_Source],
			},
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.FundsWithdrawal
 */
