...
// @generated from protobuf file "myso/rpc/v2/jwk.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.JwkId
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Jwk
 */
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.JwkId
 */
export const JwkId = new JwkId$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Jwk$Type extends MessageType<Jwk> {
	constructor() {
		super('myso.rpc.v2.Jwk', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Jwk
 */
