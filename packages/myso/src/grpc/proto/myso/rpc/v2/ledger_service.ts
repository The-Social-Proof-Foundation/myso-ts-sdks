...
/**
 * @generated from protobuf message myso.rpc.v2.GetServiceInfoRequest
 */
export interface GetServiceInfoRequest {}
/**
 * @generated from protobuf message myso.rpc.v2.GetServiceInfoResponse
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetObjectRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetObjectResponse
 */
export interface GetObjectResponse {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Object object = 1;
	 */
	object?: Object;
}
/**
 * @generated from protobuf message myso.rpc.v2.BatchGetObjectsRequest
 */
export interface BatchGetObjectsRequest {
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.GetObjectRequest requests = 1;
	 */
...
/**
 * @generated from protobuf message myso.rpc.v2.BatchGetObjectsResponse
 */
export interface BatchGetObjectsResponse {
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.GetObjectResult objects = 1;
	 */
	objects: GetObjectResult[];
}
/**
 * @generated from protobuf message myso.rpc.v2.GetObjectResult
 */
export interface GetObjectResult {
	...
	result:
		| {
				oneofKind: 'object';
				/**
				 * @generated from protobuf field: myso.rpc.v2.Object object = 1;
				 */
				object: Object;
		  }
		| {
...
/**
 * @generated from protobuf message myso.rpc.v2.GetTransactionRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetTransactionResponse
 */
export interface GetTransactionResponse {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ExecutedTransaction transaction = 1;
	 */
	transaction?: ExecutedTransaction;
}
/**
 * @generated from protobuf message myso.rpc.v2.BatchGetTransactionsRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.BatchGetTransactionsResponse
 */
export interface BatchGetTransactionsResponse {
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.GetTransactionResult transactions = 1;
	 */
	transactions: GetTransactionResult[];
}
/**
 * @generated from protobuf message myso.rpc.v2.GetTransactionResult
 */
export interface GetTransactionResult {
	...
	result:
		| {
				...
				/**
				 * @generated from protobuf field: myso.rpc.v2.ExecutedTransaction transaction = 1;
				 */
				transaction: ExecutedTransaction;
		  }
		| {
...
/**
 * @generated from protobuf message myso.rpc.v2.GetCheckpointRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetCheckpointResponse
 */
export interface GetCheckpointResponse {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Checkpoint checkpoint = 1;
	 */
	checkpoint?: Checkpoint;
}
/**
 * @generated from protobuf message myso.rpc.v2.GetEpochRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetEpochResponse
 */
export interface GetEpochResponse {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Epoch epoch = 1;
	 */
	epoch?: Epoch;
}
...
class GetServiceInfoRequest$Type extends MessageType<GetServiceInfoRequest> {
	constructor() {
		super('myso.rpc.v2.GetServiceInfoRequest', []);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetServiceInfoRequest
 */
...
class GetServiceInfoResponse$Type extends MessageType<GetServiceInfoResponse> {
	constructor() {
		super('myso.rpc.v2.GetServiceInfoResponse', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetServiceInfoResponse
 */
...
class GetObjectRequest$Type extends MessageType<GetObjectRequest> {
	constructor() {
		super('myso.rpc.v2.GetObjectRequest', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetObjectRequest
 */
...
class GetObjectResponse$Type extends MessageType<GetObjectResponse> {
	constructor() {
		super('myso.rpc.v2.GetObjectResponse', [
			{ no: 1, name: 'object', kind: 'message', T: () => Object },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetObjectResponse
 */
...
class BatchGetObjectsRequest$Type extends MessageType<BatchGetObjectsRequest> {
	constructor() {
		super('myso.rpc.v2.BatchGetObjectsRequest', [
			{
				no: 1,
				name: 'requests',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.BatchGetObjectsRequest
 */
...
class BatchGetObjectsResponse$Type extends MessageType<BatchGetObjectsResponse> {
	constructor() {
		super('myso.rpc.v2.BatchGetObjectsResponse', [
			{
				no: 1,
				name: 'objects',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.BatchGetObjectsResponse
 */
...
class GetObjectResult$Type extends MessageType<GetObjectResult> {
	constructor() {
		super('myso.rpc.v2.GetObjectResult', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetObjectResult
 */
...
class GetTransactionRequest$Type extends MessageType<GetTransactionRequest> {
	constructor() {
		super('myso.rpc.v2.GetTransactionRequest', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetTransactionRequest
 */
...
class GetTransactionResponse$Type extends MessageType<GetTransactionResponse> {
	constructor() {
		super('myso.rpc.v2.GetTransactionResponse', [
			{ no: 1, name: 'transaction', kind: 'message', T: () => ExecutedTransaction },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetTransactionResponse
 */
...
class BatchGetTransactionsRequest$Type extends MessageType<BatchGetTransactionsRequest> {
	constructor() {
		super('myso.rpc.v2.BatchGetTransactionsRequest', [
			{
				no: 1,
				name: 'digests',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.BatchGetTransactionsRequest
 */
...
class BatchGetTransactionsResponse$Type extends MessageType<BatchGetTransactionsResponse> {
	constructor() {
		super('myso.rpc.v2.BatchGetTransactionsResponse', [
			{
				no: 1,
				name: 'transactions',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.BatchGetTransactionsResponse
 */
...
class GetTransactionResult$Type extends MessageType<GetTransactionResult> {
	constructor() {
		super('myso.rpc.v2.GetTransactionResult', [
			{
				no: 1,
				name: 'transaction',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetTransactionResult
 */
...
class GetCheckpointRequest$Type extends MessageType<GetCheckpointRequest> {
	constructor() {
		super('myso.rpc.v2.GetCheckpointRequest', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetCheckpointRequest
 */
...
class GetCheckpointResponse$Type extends MessageType<GetCheckpointResponse> {
	constructor() {
		super('myso.rpc.v2.GetCheckpointResponse', [
			{ no: 1, name: 'checkpoint', kind: 'message', T: () => Checkpoint },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetCheckpointResponse
 */
...
class GetEpochRequest$Type extends MessageType<GetEpochRequest> {
	constructor() {
		super('myso.rpc.v2.GetEpochRequest', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetEpochRequest
 */
export const GetEpochRequest = new GetEpochRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetEpochResponse$Type extends MessageType<GetEpochResponse> {
	constructor() {
		super('myso.rpc.v2.GetEpochResponse', [
			{ no: 1, name: 'epoch', kind: 'message', T: () => Epoch },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetEpochResponse
 */
export const GetEpochResponse = new GetEpochResponse$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.LedgerService
 */
export const LedgerService = new ServiceType('myso.rpc.v2.LedgerService', [
