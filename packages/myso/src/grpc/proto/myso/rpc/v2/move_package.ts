...
// @generated from protobuf file "myso/rpc/v2/move_package.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 * A Move Package
 *
 * @generated from protobuf message myso.rpc.v2.Package
 */
export interface Package {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Module modules = 4;
	 */
	modules: Module[];
	/**
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.TypeOrigin type_origins = 5;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Linkage linkage = 6;
	 */
	linkage: Linkage[];
}
/**
 * A Move Module.
 *
 * @generated from protobuf message myso.rpc.v2.Module
 */
export interface Module {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.DatatypeDescriptor datatypes = 3;
	 */
	datatypes: DatatypeDescriptor[];
	/**
	 * List of Functions defined by this module.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.FunctionDescriptor functions = 4;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.DatatypeDescriptor
 */
export interface DatatypeDescriptor {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Ability abilities = 5;
	 */
	abilities: Ability[];
	/**
	 * Ability constraints and phantom status for this type's generic type parameters
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.TypeParameter type_parameters = 6;
	 */
	typeParameters: TypeParameter[];
	/**
	 * Indicates whether this datatype is a 'STRUCT' or an 'ENUM'
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.DatatypeDescriptor.DatatypeKind kind = 7;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.FieldDescriptor fields = 8;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.VariantDescriptor variants = 9;
	 */
	variants: VariantDescriptor[];
}
/**
 * @generated from protobuf enum myso.rpc.v2.DatatypeDescriptor.DatatypeKind
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.TypeParameter
 */
export interface TypeParameter {
	/**
	 * The type parameter constraints
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Ability constraints = 1;
	 */
	constraints: Ability[];
	/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.FieldDescriptor
 */
export interface FieldDescriptor {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.OpenSignatureBody type = 3;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.VariantDescriptor
 */
export interface VariantDescriptor {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.FieldDescriptor fields = 3;
	 */
	fields: FieldDescriptor[];
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.OpenSignatureBody
 */
export interface OpenSignatureBody {
	/**
	 * Type of this signature
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.OpenSignatureBody.Type type = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.OpenSignatureBody type_parameter_instantiation = 3;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.OpenSignatureBody.Type
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.FunctionDescriptor
 */
export interface FunctionDescriptor {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.FunctionDescriptor.Visibility visibility = 5;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.TypeParameter type_parameters = 7;
	 */
	typeParameters: TypeParameter[];
	/**
	 * Formal parameter types.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.OpenSignature parameters = 8;
	 */
	parameters: OpenSignature[];
	/**
	 * Return types.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.OpenSignature returns = 9;
	 */
	returns: OpenSignature[];
}
/**
 * @generated from protobuf enum myso.rpc.v2.FunctionDescriptor.Visibility
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.OpenSignature
 */
export interface OpenSignature {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.OpenSignature.Reference reference = 1;
	 */
	reference?: OpenSignature_Reference;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.OpenSignatureBody body = 2;
	 */
	body?: OpenSignatureBody;
}
/**
 * @generated from protobuf enum myso.rpc.v2.OpenSignature.Reference
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.TypeOrigin
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Linkage
 */
 ...
 *
 * @generated from protobuf enum myso.rpc.v2.Ability
 */
export enum Ability {
	/**
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Package
 */
export const Package = new Package$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Module$Type extends MessageType<Module> {
	constructor() {
		super('myso.rpc.v2.Module', [
	...
	constructor() {
		super('myso.rpc.v2.DatatypeDescriptor', [
			...
			},
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.DatatypeDescriptor.DatatypeKind', DatatypeDescriptor_DatatypeKind],
			},
			{
				no: 8,
				name: 'fields',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.VariantDescriptor
 */
...
class OpenSignatureBody$Type extends MessageType<OpenSignatureBody> {
	constructor() {
		super('myso.rpc.v2.OpenSignatureBody', [
			{
				no: 1,
				name: 'type',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.OpenSignatureBody.Type', OpenSignatureBody_Type],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.OpenSignatureBody
 */
...
class FunctionDescriptor$Type extends MessageType<FunctionDescriptor> {
	constructor() {
		super('myso.rpc.v2.FunctionDescriptor', [
			{ no: 1, name: 'name', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				no: 5,
				name: 'visibility',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.FunctionDescriptor.Visibility', FunctionDescriptor_Visibility],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.FunctionDescriptor
 */
export const FunctionDescriptor = new FunctionDescriptor$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OpenSignature$Type extends MessageType<OpenSignature> {
	constructor() {
		super('myso.rpc.v2.OpenSignature', [
			{
				no: 1,
				name: 'reference',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.OpenSignature.Reference', OpenSignature_Reference],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.TypeOrigin
 */
export const TypeOrigin = new TypeOrigin$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Linkage$Type extends MessageType<Linkage> {
	constructor() {
		super('myso.rpc.v2.Linkage', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Linkage
 */
