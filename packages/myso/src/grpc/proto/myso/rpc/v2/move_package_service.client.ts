...
/**
 * @generated from protobuf service myso.rpc.v2.MovePackageService
 */
export interface IMovePackageServiceClient {
	/**
	 * @generated from protobuf rpc: GetPackage(myso.rpc.v2.GetPackageRequest) returns (myso.rpc.v2.GetPackageResponse);
	 */
	getPackage(
	...
	/**
	 * @generated from protobuf rpc: GetDatatype(myso.rpc.v2.GetDatatypeRequest) returns (myso.rpc.v2.GetDatatypeResponse);
	 */
	getDatatype(
	...
	/**
	 * @generated from protobuf rpc: GetFunction(myso.rpc.v2.GetFunctionRequest) returns (myso.rpc.v2.GetFunctionResponse);
	 */
	getFunction(
	...
	/**
	 * @generated from protobuf rpc: ListPackageVersions(myso.rpc.v2.ListPackageVersionsRequest) returns (myso.rpc.v2.ListPackageVersionsResponse);
	 */
	listPackageVersions(
