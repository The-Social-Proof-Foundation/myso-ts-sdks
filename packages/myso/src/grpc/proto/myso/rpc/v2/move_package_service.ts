...
// @generated from protobuf file "myso/rpc/v2/move_package_service.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message myso.rpc.v2.GetPackageRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetPackageResponse
 */
export interface GetPackageResponse {
	/**
	 * The package.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Package package = 1;
	 */
	package?: Package;
}
/**
 * @generated from protobuf message myso.rpc.v2.GetDatatypeRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetDatatypeResponse
 */
export interface GetDatatypeResponse {
	/**
	 * The datatype.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.DatatypeDescriptor datatype = 1;
	 */
	datatype?: DatatypeDescriptor;
}
/**
 * @generated from protobuf message myso.rpc.v2.GetFunctionRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.GetFunctionResponse
 */
export interface GetFunctionResponse {
	/**
	 * The function.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.FunctionDescriptor function = 1;
	 */
	function?: FunctionDescriptor;
}
/**
 * @generated from protobuf message myso.rpc.v2.ListPackageVersionsRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.ListPackageVersionsResponse
 */
export interface ListPackageVersionsResponse {
	/**
	 * List of all package versions, ordered by version.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.PackageVersion versions = 1;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.PackageVersion
 */
...
class GetPackageRequest$Type extends MessageType<GetPackageRequest> {
	constructor() {
		super('myso.rpc.v2.GetPackageRequest', [
			{ no: 1, name: 'package_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetPackageRequest
 */
...
class GetPackageResponse$Type extends MessageType<GetPackageResponse> {
	constructor() {
		super('myso.rpc.v2.GetPackageResponse', [
			{ no: 1, name: 'package', kind: 'message', T: () => Package },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetPackageResponse
 */
...
class GetDatatypeRequest$Type extends MessageType<GetDatatypeRequest> {
	constructor() {
		super('myso.rpc.v2.GetDatatypeRequest', [
			{ no: 1, name: 'package_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetDatatypeRequest
 */
...
class GetDatatypeResponse$Type extends MessageType<GetDatatypeResponse> {
	constructor() {
		super('myso.rpc.v2.GetDatatypeResponse', [
			{ no: 1, name: 'datatype', kind: 'message', T: () => DatatypeDescriptor },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetDatatypeResponse
 */
...
class GetFunctionRequest$Type extends MessageType<GetFunctionRequest> {
	constructor() {
		super('myso.rpc.v2.GetFunctionRequest', [
			{ no: 1, name: 'package_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{ no: 2, name: 'module_name', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{ no: 3, name: 'name', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetFunctionRequest
 */
...
class GetFunctionResponse$Type extends MessageType<GetFunctionResponse> {
	constructor() {
		super('myso.rpc.v2.GetFunctionResponse', [
			{ no: 1, name: 'function', kind: 'message', T: () => FunctionDescriptor },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetFunctionResponse
 */
...
class ListPackageVersionsRequest$Type extends MessageType<ListPackageVersionsRequest> {
	constructor() {
		super('myso.rpc.v2.ListPackageVersionsRequest', [
			{ no: 1, name: 'package_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListPackageVersionsRequest
 */
...
class ListPackageVersionsResponse$Type extends MessageType<ListPackageVersionsResponse> {
	constructor() {
		super('myso.rpc.v2.ListPackageVersionsResponse', [
			{
				no: 1,
				name: 'versions',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListPackageVersionsResponse
 */
...
class PackageVersion$Type extends MessageType<PackageVersion> {
	constructor() {
		super('myso.rpc.v2.PackageVersion', [
			{ no: 1, name: 'package_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				no: 2,
				name: 'version',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.PackageVersion
 */
export const PackageVersion = new PackageVersion$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.MovePackageService
 */
export const MovePackageService = new ServiceType('myso.rpc.v2.MovePackageService', [
