...
/**
 * @generated from protobuf service myso.rpc.v2.NameService
 */
export interface INameServiceClient {
	/**
	 * @generated from protobuf rpc: LookupName(myso.rpc.v2.LookupNameRequest) returns (myso.rpc.v2.LookupNameResponse);
	 */
	lookupName(
	...
	/**
	 * @generated from protobuf rpc: ReverseLookupName(myso.rpc.v2.ReverseLookupNameRequest) returns (myso.rpc.v2.ReverseLookupNameResponse);
	 */
	reverseLookupName(
