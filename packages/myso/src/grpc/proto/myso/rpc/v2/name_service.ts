...
// @generated from protobuf file "myso/rpc/v2/name_service.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message myso.rpc.v2.LookupNameRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.LookupNameResponse
 */
export interface LookupNameResponse {
	/**
	 * The record for the requested name
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.NameRecord record = 1;
	 */
	record?: NameRecord;
}
/**
 * @generated from protobuf message myso.rpc.v2.ReverseLookupNameRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.ReverseLookupNameResponse
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.NameRecord
 */
...
class LookupNameRequest$Type extends MessageType<LookupNameRequest> {
	constructor() {
		super('myso.rpc.v2.LookupNameRequest', [
			{ no: 1, name: 'name', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.LookupNameRequest
 */
...
class LookupNameResponse$Type extends MessageType<LookupNameResponse> {
	constructor() {
		super('myso.rpc.v2.LookupNameResponse', [
			{ no: 1, name: 'record', kind: 'message', T: () => NameRecord },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.LookupNameResponse
 */
...
class ReverseLookupNameRequest$Type extends MessageType<ReverseLookupNameRequest> {
	constructor() {
		super('myso.rpc.v2.ReverseLookupNameRequest', [
			{ no: 1, name: 'address', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ReverseLookupNameRequest
 */
...
class ReverseLookupNameResponse$Type extends MessageType<ReverseLookupNameResponse> {
	constructor() {
		super('myso.rpc.v2.ReverseLookupNameResponse', [
			{ no: 1, name: 'record', kind: 'message', T: () => NameRecord },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ReverseLookupNameResponse
 */
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.NameRecord
 */
export const NameRecord = new NameRecord$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.NameService
 */
export const NameService = new ServiceType('myso.rpc.v2.NameService', [
