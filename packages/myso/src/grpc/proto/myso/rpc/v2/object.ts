...
// @generated from protobuf file "myso/rpc/v2/object.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Object
 */
export interface Object {
	 ...
	 * Owner of the object.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Owner owner = 5;
	 */
	owner?: Owner;
	/**
	 ...
	 * Only set for Move structs
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs contents = 8;
	 */
	contents?: Bcs;
	/**
	 * Package information for Move Packages
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Package package = 9;
	 */
	package?: Package;
	/**
 ...
 * Set of Objects
 *
 * @generated from protobuf message myso.rpc.v2.ObjectSet
 */
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Object
 */
export const Object = new Object$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ObjectSet$Type extends MessageType<ObjectSet> {
	constructor() {
		super('myso.rpc.v2.ObjectSet', [
			{ no: 1, name: 'objects', kind: 'message', repeat: 1 /*RepeatType.PACKED*/, T: () => Object },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ObjectSet
 */
