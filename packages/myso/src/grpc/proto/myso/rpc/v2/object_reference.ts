...
// @generated from protobuf file "myso/rpc/v2/object_reference.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ObjectReference
 */
...
class ObjectReference$Type extends MessageType<ObjectReference> {
	constructor() {
		super('myso.rpc.v2.ObjectReference', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ObjectReference
 */
