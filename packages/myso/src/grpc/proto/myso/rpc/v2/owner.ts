...
// @generated from protobuf file "myso/rpc/v2/owner.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Owner
 */
export interface Owner {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Owner.OwnerKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.Owner.OwnerKind
 */
...
class Owner$Type extends MessageType<Owner> {
	constructor() {
		super('myso.rpc.v2.Owner', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.Owner.OwnerKind', Owner_OwnerKind],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Owner
 */
