...
// @generated from protobuf file "myso/rpc/v2/protocol_config.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message myso.rpc.v2.ProtocolConfig
 */
...
class ProtocolConfig$Type extends MessageType<ProtocolConfig> {
	constructor() {
		super('myso.rpc.v2.ProtocolConfig', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ProtocolConfig
 */
