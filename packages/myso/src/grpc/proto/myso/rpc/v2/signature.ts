...
// @generated from protobuf file "myso/rpc/v2/signature.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.UserSignature
 */
export interface UserSignature {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.SignatureScheme scheme = 2;
	 */
	...
	signature:
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.SimpleSignature simple = 3;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.MultisigAggregatedSignature multisig = 4;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.ZkLoginAuthenticator zklogin = 5;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.PasskeyAuthenticator passkey = 6;
				 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.SimpleSignature
 */
export interface SimpleSignature {
	/**
	 * The signature scheme of this signature.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.SignatureScheme scheme = 1;
	 */
	scheme?: SignatureScheme;
	/**
	 * Signature bytes
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ZkLoginPublicIdentifier
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MultisigMemberPublicKey
 */
export interface MultisigMemberPublicKey {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ZkLoginPublicIdentifier zklogin = 3;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MultisigMember
 */
export interface MultisigMember {
	/**
	 * The public key of the committee member.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.MultisigMemberPublicKey public_key = 1;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MultisigCommittee
 */
export interface MultisigCommittee {
	/**
	 * A list of committee members and their corresponding weight.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.MultisigMember members = 1;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MultisigAggregatedSignature
 */
export interface MultisigAggregatedSignature {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.MultisigMemberSignature signatures = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.MultisigCommittee committee = 4;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MultisigMemberSignature
 */
export interface MultisigMemberSignature {
	 ...
	 * The zklogin authenticator if scheme is `ZKLOGIN`.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ZkLoginAuthenticator zklogin = 3;
	 */
	zklogin?: ZkLoginAuthenticator;
	/**
	 * The passkey authenticator if scheme is `PASSKEY`.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.PasskeyAuthenticator passkey = 4;
	 */
	passkey?: PasskeyAuthenticator;
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ZkLoginAuthenticator
 */
export interface ZkLoginAuthenticator {
	/**
	 * Zklogin proof and inputs required to perform proof verification.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ZkLoginInputs inputs = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.SimpleSignature signature = 3;
	 */
	signature?: SimpleSignature;
	/**
	 * The public identifier (similar to a public key) for this zklogin authenticator
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ZkLoginPublicIdentifier public_identifier = 4;
	 */
	publicIdentifier?: ZkLoginPublicIdentifier;
	/**
	 * The id of the JWK used to authorize this zklogin authenticator
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.JwkId jwk_id = 5;
	 */
	jwkId?: JwkId;
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ZkLoginInputs
 */
export interface ZkLoginInputs {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ZkLoginProof proof_points = 1;
	 */
	proofPoints?: ZkLoginProof;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ZkLoginClaim iss_base64_details = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ZkLoginProof
 */
export interface ZkLoginProof {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.CircomG1 a = 1;
	 */
	a?: CircomG1;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.CircomG2 b = 2;
	 */
	b?: CircomG2;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.CircomG1 c = 3;
	 */
	c?: CircomG1;
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ZkLoginClaim
 */
 ...
 * A G1 point.
 *
 * @generated from protobuf message myso.rpc.v2.CircomG1
 */
 ...
 * A G2 point.
 *
 * @generated from protobuf message myso.rpc.v2.CircomG2
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.PasskeyAuthenticator
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ValidatorCommittee
 */
export interface ValidatorCommittee {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.ValidatorCommitteeMember members = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ValidatorCommitteeMember
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ValidatorAggregatedSignature
 */
...
class UserSignature$Type extends MessageType<UserSignature> {
	constructor() {
		super('myso.rpc.v2.UserSignature', [
			{ no: 1, name: 'bcs', kind: 'message', T: () => Bcs },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.SignatureScheme', SignatureScheme],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.SimpleSignature
 */
...
class ZkLoginPublicIdentifier$Type extends MessageType<ZkLoginPublicIdentifier> {
	constructor() {
		super('myso.rpc.v2.ZkLoginPublicIdentifier', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ZkLoginPublicIdentifier
 */
...
class MultisigMemberPublicKey$Type extends MessageType<MultisigMemberPublicKey> {
	constructor() {
		super('myso.rpc.v2.MultisigMemberPublicKey', [
			{
				no: 1,
				name: 'scheme',
				kind: 'enum',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.MultisigMemberPublicKey
 */
...
class MultisigMember$Type extends MessageType<MultisigMember> {
	constructor() {
		super('myso.rpc.v2.MultisigMember', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.MultisigCommittee
 */
...
class MultisigAggregatedSignature$Type extends MessageType<MultisigAggregatedSignature> {
	constructor() {
		super('myso.rpc.v2.MultisigAggregatedSignature', [
			{
				no: 1,
				name: 'signatures',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.MultisigAggregatedSignature
 */
...
class MultisigMemberSignature$Type extends MessageType<MultisigMemberSignature> {
	constructor() {
		super('myso.rpc.v2.MultisigMemberSignature', [
			{
				no: 1,
				name: 'scheme',
				kind: 'enum',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.MultisigMemberSignature
 */
...
class ZkLoginAuthenticator$Type extends MessageType<ZkLoginAuthenticator> {
	constructor() {
		super('myso.rpc.v2.ZkLoginAuthenticator', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ZkLoginAuthenticator
 */
...
class ZkLoginInputs$Type extends MessageType<ZkLoginInputs> {
	constructor() {
		super('myso.rpc.v2.ZkLoginInputs', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CircomG1
 */
export const CircomG1 = new CircomG1$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CircomG2$Type extends MessageType<CircomG2> {
	constructor() {
		super('myso.rpc.v2.CircomG2', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.PasskeyAuthenticator
 */
...
class ValidatorCommittee$Type extends MessageType<ValidatorCommittee> {
	constructor() {
		super('myso.rpc.v2.ValidatorCommittee', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ValidatorCommittee
 */
...
class ValidatorCommitteeMember$Type extends MessageType<ValidatorCommitteeMember> {
	constructor() {
		super('myso.rpc.v2.ValidatorCommitteeMember', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ValidatorCommitteeMember
 */
...
class ValidatorAggregatedSignature$Type extends MessageType<ValidatorAggregatedSignature> {
	constructor() {
		super('myso.rpc.v2.ValidatorAggregatedSignature', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ValidatorAggregatedSignature
 */
