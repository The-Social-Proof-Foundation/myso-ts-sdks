...
/**
 * @generated from protobuf message myso.rpc.v2.VerifySignatureRequest
 */
export interface VerifySignatureRequest {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs message = 1;
	 */
	message?: Bcs;
	/**
	 * The signature to verify.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.UserSignature signature = 2;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.ActiveJwk jwks = 4;
	 */
	jwks: ActiveJwk[];
}
/**
 * @generated from protobuf message myso.rpc.v2.VerifySignatureResponse
 */
...
class VerifySignatureRequest$Type extends MessageType<VerifySignatureRequest> {
	constructor() {
		super('myso.rpc.v2.VerifySignatureRequest', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.VerifySignatureRequest
 */
...
class VerifySignatureResponse$Type extends MessageType<VerifySignatureResponse> {
	constructor() {
		super('myso.rpc.v2.VerifySignatureResponse', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.VerifySignatureResponse
 */
export const VerifySignatureResponse = new VerifySignatureResponse$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.SignatureVerificationService
 */
