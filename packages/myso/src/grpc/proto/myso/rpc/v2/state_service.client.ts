...
/**
 * @generated from protobuf service myso.rpc.v2.StateService
 */
export interface IStateServiceClient {
	/**
	 * @generated from protobuf rpc: ListDynamicFields(myso.rpc.v2.ListDynamicFieldsRequest) returns (myso.rpc.v2.ListDynamicFieldsResponse);
	 */
	listDynamicFields(
	...
	/**
	 * @generated from protobuf rpc: ListOwnedObjects(myso.rpc.v2.ListOwnedObjectsRequest) returns (myso.rpc.v2.ListOwnedObjectsResponse);
	 */
	listOwnedObjects(
	...
	/**
	 * @generated from protobuf rpc: GetCoinInfo(myso.rpc.v2.GetCoinInfoRequest) returns (myso.rpc.v2.GetCoinInfoResponse);
	 */
	getCoinInfo(
	...
	/**
	 * @generated from protobuf rpc: GetBalance(myso.rpc.v2.GetBalanceRequest) returns (myso.rpc.v2.GetBalanceResponse);
	 */
	getBalance(
	...
	/**
	 * @generated from protobuf rpc: ListBalances(myso.rpc.v2.ListBalancesRequest) returns (myso.rpc.v2.ListBalancesResponse);
	 */
	listBalances(
