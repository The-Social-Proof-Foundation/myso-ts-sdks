...
// @generated from protobuf file "myso/rpc/v2/state_service.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GetCoinInfoRequest
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GetCoinInfoResponse
 */
export interface GetCoinInfoResponse {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.CoinMetadata metadata = 2;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.CoinTreasury treasury = 3;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.RegulatedCoinMetadata regulated_metadata = 4;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CoinMetadata
 */
export interface CoinMetadata {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.CoinMetadata.MetadataCapState metadata_cap_state = 8;
	 */
 ...
 *
 * @generated from protobuf enum myso.rpc.v2.CoinMetadata.MetadataCapState
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CoinTreasury
 */
export interface CoinTreasury {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.CoinTreasury.SupplyState supply_state = 3;
	 */
 ...
 *
 * @generated from protobuf enum myso.rpc.v2.CoinTreasury.SupplyState
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.RegulatedCoinMetadata
 */
export interface RegulatedCoinMetadata {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.RegulatedCoinMetadata.CoinRegulatedState coin_regulated_state = 6;
	 */
 ...
 *
 * @generated from protobuf enum myso.rpc.v2.RegulatedCoinMetadata.CoinRegulatedState
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GetBalanceRequest
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GetBalanceResponse
 */
export interface GetBalanceResponse {
	/**
	 * The balance information for the requested coin type.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Balance balance = 1;
	 */
	balance?: Balance;
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ListBalancesRequest
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ListBalancesResponse
 */
export interface ListBalancesResponse {
	/**
	 * The list of coin types and their respective balances.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Balance balances = 1;
	 */
	balances: Balance[];
	/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Balance
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ListDynamicFieldsRequest
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ListDynamicFieldsResponse
 */
export interface ListDynamicFieldsResponse {
	/**
	 * Page of dynamic fields owned by the specified parent.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.DynamicField dynamic_fields = 1;
	 */
...
/**
 * @generated from protobuf message myso.rpc.v2.DynamicField
 */
export interface DynamicField {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.DynamicField.DynamicFieldKind kind = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Object field_object = 4;
	 */
	fieldObject?: Object;
	/**
	 * The dynamic field's "name"
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs name = 5;
	 */
	name?: Bcs;
	/**
	 * The dynamic field's "value"
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs value = 6;
	 */
	value?: Bcs;
	/**
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Object child_object = 9;
	 */
	childObject?: Object;
}
/**
 * @generated from protobuf enum myso.rpc.v2.DynamicField.DynamicFieldKind
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.ListOwnedObjectsRequest
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.ListOwnedObjectsResponse
 */
...
class GetCoinInfoRequest$Type extends MessageType<GetCoinInfoRequest> {
	constructor() {
		super('myso.rpc.v2.GetCoinInfoRequest', [
			{ no: 1, name: 'coin_type', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetCoinInfoRequest
 */
...
class GetCoinInfoResponse$Type extends MessageType<GetCoinInfoResponse> {
	constructor() {
		super('myso.rpc.v2.GetCoinInfoResponse', [
			{ no: 1, name: 'coin_type', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
	...
	constructor() {
		super('myso.rpc.v2.CoinMetadata', [
			...
			{ no: 7, name: 'metadata_cap_id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.CoinMetadata.MetadataCapState', CoinMetadata_MetadataCapState],
			},
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CoinMetadata
 */
export const CoinMetadata = new CoinMetadata$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CoinTreasury$Type extends MessageType<CoinTreasury> {
	constructor() {
		super('myso.rpc.v2.CoinTreasury', [
			{ no: 1, name: 'id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				no: 2,
				name: 'total_supply',
			...
			},
			{
				...
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.CoinTreasury.SupplyState', CoinTreasury_SupplyState],
			},
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CoinTreasury
 */
...
class RegulatedCoinMetadata$Type extends MessageType<RegulatedCoinMetadata> {
	constructor() {
		super('myso.rpc.v2.RegulatedCoinMetadata', [
			{ no: 1, name: 'id', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{
				no: 2,
			...
			{ no: 5, name: 'variant', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.RegulatedCoinMetadata.CoinRegulatedState',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.RegulatedCoinMetadata
 */
...
class GetBalanceRequest$Type extends MessageType<GetBalanceRequest> {
	constructor() {
		super('myso.rpc.v2.GetBalanceRequest', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetBalanceRequest
 */
...
class GetBalanceResponse$Type extends MessageType<GetBalanceResponse> {
	constructor() {
		super('myso.rpc.v2.GetBalanceResponse', [
			{ no: 1, name: 'balance', kind: 'message', T: () => Balance },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.GetBalanceResponse
 */
...
class ListBalancesRequest$Type extends MessageType<ListBalancesRequest> {
	constructor() {
		super('myso.rpc.v2.ListBalancesRequest', [
			{ no: 1, name: 'owner', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListBalancesRequest
 */
...
class ListBalancesResponse$Type extends MessageType<ListBalancesResponse> {
	constructor() {
		super('myso.rpc.v2.ListBalancesResponse', [
			{
				no: 1,
				name: 'balances',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListDynamicFieldsRequest
 */
...
class ListDynamicFieldsResponse$Type extends MessageType<ListDynamicFieldsResponse> {
	constructor() {
		super('myso.rpc.v2.ListDynamicFieldsResponse', [
			{
				no: 1,
				name: 'dynamic_fields',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListDynamicFieldsResponse
 */
...
class DynamicField$Type extends MessageType<DynamicField> {
	constructor() {
		super('myso.rpc.v2.DynamicField', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.DynamicField.DynamicFieldKind', DynamicField_DynamicFieldKind],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.DynamicField
 */
...
class ListOwnedObjectsRequest$Type extends MessageType<ListOwnedObjectsRequest> {
	constructor() {
		super('myso.rpc.v2.ListOwnedObjectsRequest', [
			{ no: 1, name: 'owner', kind: 'scalar', opt: true, T: 9 /*ScalarType.STRING*/ },
			{ no: 2, name: 'page_size', kind: 'scalar', opt: true, T: 13 /*ScalarType.UINT32*/ },
			{ no: 3, name: 'page_token', kind: 'scalar', opt: true, T: 12 /*ScalarType.BYTES*/ },
			{ no: 4, name: 'read_mask', kind: 'message', T: () => FieldMask },
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListOwnedObjectsRequest
 */
...
class ListOwnedObjectsResponse$Type extends MessageType<ListOwnedObjectsResponse> {
	constructor() {
		super('myso.rpc.v2.ListOwnedObjectsResponse', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ListOwnedObjectsResponse
 */
export const ListOwnedObjectsResponse = new ListOwnedObjectsResponse$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.StateService
 */
export const StateService = new ServiceType('myso.rpc.v2.StateService', [
	{
