...
// @generated from protobuf file "myso/rpc/v2/subscription_service.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 *
 * @generated from protobuf message myso.rpc.v2.SubscribeCheckpointsRequest
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.SubscribeCheckpointsResponse
 */
export interface SubscribeCheckpointsResponse {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Checkpoint checkpoint = 2;
	 */
...
class SubscribeCheckpointsRequest$Type extends MessageType<SubscribeCheckpointsRequest> {
	constructor() {
		super('myso.rpc.v2.SubscribeCheckpointsRequest', [
			{ no: 1, name: 'read_mask', kind: 'message', T: () => FieldMask },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.SubscribeCheckpointsRequest
 */
...
class SubscribeCheckpointsResponse$Type extends MessageType<SubscribeCheckpointsResponse> {
	constructor() {
		super('myso.rpc.v2.SubscribeCheckpointsResponse', [
			{
				no: 1,
				name: 'cursor',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.SubscribeCheckpointsResponse
 */
export const SubscribeCheckpointsResponse = new SubscribeCheckpointsResponse$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.SubscriptionService
 */
export const SubscriptionService = new ServiceType('myso.rpc.v2.SubscriptionService', [
	{
