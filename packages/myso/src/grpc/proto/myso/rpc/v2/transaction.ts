...
// @generated from protobuf file "myso/rpc/v2/transaction.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
 ...
 * A transaction.
 *
 * @generated from protobuf message myso.rpc.v2.Transaction
 */
export interface Transaction {
	/**
	 * This Transaction serialized as BCS.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs bcs = 1;
	 */
	bcs?: Bcs;
	/**
	...
	version?: number;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.TransactionKind kind = 4;
	 */
	...
	sender?: string;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.GasPayment gas_payment = 6;
	 */
	gasPayment?: GasPayment;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.TransactionExpiration expiration = 7;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GasPayment
 */
export interface GasPayment {
	/**
	 * Set of gas objects to use for payment.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.ObjectReference objects = 1;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.TransactionExpiration
 */
export interface TransactionExpiration {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.TransactionExpiration.TransactionExpirationKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.TransactionExpiration.TransactionExpirationKind
 */
 ...
 * Transaction type.
 *
 * @generated from protobuf message myso.rpc.v2.TransactionKind
 */
export interface TransactionKind {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.TransactionKind.Kind kind = 1;
	 */
	...
	data:
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.ProgrammableTransaction programmable_transaction = 2;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.ChangeEpoch change_epoch = 3;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.GenesisTransaction genesis = 4;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.ConsensusCommitPrologue consensus_commit_prologue = 5;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.AuthenticatorStateUpdate authenticator_state_update = 6;
				 */
		...
		| {
				 ...
				 * the next one.
				 *
				 * @generated from protobuf field: myso.rpc.v2.EndOfEpochTransaction end_of_epoch = 7;
				 */
		...
		| {
				 ...
				 * Randomness update.
				 *
				 * @generated from protobuf field: myso.rpc.v2.RandomnessStateUpdate randomness_state_update = 8;
				 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.TransactionKind.Kind
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ProgrammableTransaction
 */
export interface ProgrammableTransaction {
	/**
	 * Input objects or primitive values.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Input inputs = 1;
	 */
	inputs: Input[];
	/**
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Command commands = 2;
	 */
	commands: Command[];
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Command
 */
export interface Command {
	...
	command:
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.MoveCall move_call = 1;
				 */
				moveCall: MoveCall;
		  }
		| {
				 ...
				 * be newly created.
				 *
				 * @generated from protobuf field: myso.rpc.v2.TransferObjects transfer_objects = 2;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.SplitCoins split_coins = 3;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.MergeCoins merge_coins = 4;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.Publish publish = 5;
				 */
				publish: Publish;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.MakeMoveVector make_move_vector = 6;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.Upgrade upgrade = 7;
				 */
				upgrade: Upgrade;
		  }
		| {
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MoveCall
 */
export interface MoveCall {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Argument arguments = 5;
	 */
	arguments: Argument[];
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.TransferObjects
 */
export interface TransferObjects {
	/**
	 * Set of objects to transfer.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Argument objects = 1;
	 */
	objects: Argument[];
	/**
	 * The address to transfer ownership to.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Argument address = 2;
	 */
	address?: Argument;
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.SplitCoins
 */
export interface SplitCoins {
	/**
	 * The coin to split.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Argument coin = 1;
	 */
	coin?: Argument;
	/**
	 * The amounts to split off.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Argument amounts = 2;
	 */
	amounts: Argument[];
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MergeCoins
 */
export interface MergeCoins {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Argument coins_to_merge = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Publish
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.MakeMoveVector
 */
export interface MakeMoveVector {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Argument elements = 2;
	 */
	elements: Argument[];
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.Upgrade
 */
export interface Upgrade {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Argument ticket = 4;
	 */
	ticket?: Argument;
}
/**
 * Randomness update.
 *
 * @generated from protobuf message myso.rpc.v2.RandomnessStateUpdate
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ChangeEpoch
 */
export interface ChangeEpoch {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.SystemPackage system_packages = 8;
	 */
 ...
 * System package.
 *
 * @generated from protobuf message myso.rpc.v2.SystemPackage
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.GenesisTransaction
 */
export interface GenesisTransaction {
	/**
	 * Set of genesis objects.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.Object objects = 1;
	 */
	objects: Object[];
}
/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ConsensusCommitPrologue
 */
export interface ConsensusCommitPrologue {
	 ...
	 * Present in V3, V4.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.ConsensusDeterminedVersionAssignments consensus_determined_version_assignments = 6;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.VersionAssignment
 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CanceledTransaction
 */
export interface CanceledTransaction {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.VersionAssignment version_assignments = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ConsensusDeterminedVersionAssignments
 */
export interface ConsensusDeterminedVersionAssignments {
	 ...
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.CanceledTransaction canceled_transactions = 3;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.AuthenticatorStateUpdate
 */
export interface AuthenticatorStateUpdate {
	 ...
	 * Newly active JWKs.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.ActiveJwk new_active_jwks = 3;
	 */
 ...
 * A new JWK.
 *
 * @generated from protobuf message myso.rpc.v2.ActiveJwk
 */
export interface ActiveJwk {
	/**
	 * Identifier used to uniquely identify a JWK.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.JwkId id = 1;
	 */
	id?: JwkId;
	/**
	 * The JWK.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Jwk jwk = 2;
	 */
	jwk?: Jwk;
	/**
 ...
 *
 * @generated from protobuf message myso.rpc.v2.EndOfEpochTransaction
 */
export interface EndOfEpochTransaction {
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.EndOfEpochTransactionKind transactions = 1;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.EndOfEpochTransactionKind
 */
export interface EndOfEpochTransactionKind {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.EndOfEpochTransactionKind.Kind kind = 1;
	 */
	...
	data:
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.ChangeEpoch change_epoch = 2;
				 */
				changeEpoch: ChangeEpoch;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.AuthenticatorStateExpire authenticator_state_expire = 3;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: myso.rpc.v2.ExecutionTimeObservations execution_time_observations = 4;
				 */
...
/**
 * @generated from protobuf enum myso.rpc.v2.EndOfEpochTransactionKind.Kind
 */
 ...
 * Expire old JWKs.
 *
 * @generated from protobuf message myso.rpc.v2.AuthenticatorStateExpire
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.ExecutionTimeObservations
 */
export interface ExecutionTimeObservations {
	...
	version?: number;
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.ExecutionTimeObservation observations = 2;
	 */
	observations: ExecutionTimeObservation[];
}
/**
 * @generated from protobuf message myso.rpc.v2.ExecutionTimeObservation
 */
export interface ExecutionTimeObservation {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.ExecutionTimeObservation.ExecutionTimeObservationKind kind = 1;
	 */
	kind?: ExecutionTimeObservation_ExecutionTimeObservationKind;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.MoveCall move_entry_point = 2;
	 */
	moveEntryPoint?: MoveCall;
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.ValidatorExecutionTimeObservation validator_observations = 3;
	 */
	validatorObservations: ValidatorExecutionTimeObservation[];
}
/**
 * @generated from protobuf enum myso.rpc.v2.ExecutionTimeObservation.ExecutionTimeObservationKind
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.ValidatorExecutionTimeObservation
 */
		...
		super('myso.rpc.v2.TransactionExpiration', [
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.TransactionExpiration.TransactionExpirationKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.TransactionExpiration
 */
...
class TransactionKind$Type extends MessageType<TransactionKind> {
	constructor() {
		super('myso.rpc.v2.TransactionKind', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.TransactionKind.Kind', TransactionKind_Kind],
			},
			{
				no: 2,
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.TransactionKind
 */
...
class ProgrammableTransaction$Type extends MessageType<ProgrammableTransaction> {
	constructor() {
		super('myso.rpc.v2.ProgrammableTransaction', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.Command
 */
export const Command = new Command$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MoveCall$Type extends MessageType<MoveCall> {
	constructor() {
		super('myso.rpc.v2.MoveCall', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.MergeCoins
 */
export const MergeCoins = new MergeCoins$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Publish$Type extends MessageType<Publish> {
	constructor() {
		super('myso.rpc.v2.Publish', [
			{
				no: 1,
				name: 'modules',
				kind: 'scalar',
...
class ConsensusCommitPrologue$Type extends MessageType<ConsensusCommitPrologue> {
	constructor() {
		super('myso.rpc.v2.ConsensusCommitPrologue', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ConsensusCommitPrologue
 */
...
class VersionAssignment$Type extends MessageType<VersionAssignment> {
	constructor() {
		super('myso.rpc.v2.VersionAssignment', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.VersionAssignment
 */
...
class CanceledTransaction$Type extends MessageType<CanceledTransaction> {
	constructor() {
		super('myso.rpc.v2.CanceledTransaction', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CanceledTransaction
 */
...
class ConsensusDeterminedVersionAssignments$Type extends MessageType<ConsensusDeterminedVersionAssignments> {
	constructor() {
		super('myso.rpc.v2.ConsensusDeterminedVersionAssignments', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ConsensusDeterminedVersionAssignments
 */
...
class AuthenticatorStateUpdate$Type extends MessageType<AuthenticatorStateUpdate> {
	constructor() {
		super('myso.rpc.v2.AuthenticatorStateUpdate', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.AuthenticatorStateUpdate
 */
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.EndOfEpochTransaction
 */
...
class EndOfEpochTransactionKind$Type extends MessageType<EndOfEpochTransactionKind> {
	constructor() {
		super('myso.rpc.v2.EndOfEpochTransactionKind', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['myso.rpc.v2.EndOfEpochTransactionKind.Kind', EndOfEpochTransactionKind_Kind],
			},
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.EndOfEpochTransactionKind
 */
...
class AuthenticatorStateExpire$Type extends MessageType<AuthenticatorStateExpire> {
	constructor() {
		super('myso.rpc.v2.AuthenticatorStateExpire', [
			{
				no: 1,
				name: 'min_epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.AuthenticatorStateExpire
 */
...
class ExecutionTimeObservations$Type extends MessageType<ExecutionTimeObservations> {
	constructor() {
		super('myso.rpc.v2.ExecutionTimeObservations', [
			{ no: 1, name: 'version', kind: 'scalar', opt: true, T: 5 /*ScalarType.INT32*/ },
			{
				no: 2,
				name: 'observations',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ExecutionTimeObservations
 */
...
class ExecutionTimeObservation$Type extends MessageType<ExecutionTimeObservation> {
	constructor() {
		super('myso.rpc.v2.ExecutionTimeObservation', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => [
					'myso.rpc.v2.ExecutionTimeObservation.ExecutionTimeObservationKind',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ExecutionTimeObservation
 */
...
class ValidatorExecutionTimeObservation$Type extends MessageType<ValidatorExecutionTimeObservation> {
	constructor() {
		super('myso.rpc.v2.ValidatorExecutionTimeObservation', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ValidatorExecutionTimeObservation
 */
