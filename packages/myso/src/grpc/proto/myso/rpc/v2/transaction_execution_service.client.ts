...
/**
 * @generated from protobuf service myso.rpc.v2.TransactionExecutionService
 */
export interface ITransactionExecutionServiceClient {
	/**
	 * @generated from protobuf rpc: ExecuteTransaction(myso.rpc.v2.ExecuteTransactionRequest) returns (myso.rpc.v2.ExecuteTransactionResponse);
	 */
	executeTransaction(
	...
	/**
	 * @generated from protobuf rpc: SimulateTransaction(myso.rpc.v2.SimulateTransactionRequest) returns (myso.rpc.v2.SimulateTransactionResponse);
	 */
	simulateTransaction(
