...
// @generated from protobuf file "myso/rpc/v2/transaction_execution_service.proto" (package "myso.rpc.v2", syntax proto3)
// tslint:disable
// @ts-nocheck
//
// Copyright (c) Mysten Labs, Inc.
...
/**
 * @generated from protobuf message myso.rpc.v2.ExecuteTransactionRequest
 */
export interface ExecuteTransactionRequest {
	/**
	 * The transaction to execute.
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.Transaction transaction = 1;
	 */
	 ...
	 * transaction.
	 *
	 * @generated from protobuf field: repeated myso.rpc.v2.UserSignature signatures = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.ExecuteTransactionResponse
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.SimulateTransactionRequest
 */
export interface SimulateTransactionRequest {
	 ...
	 *
	 * @generated from protobuf field: optional myso.rpc.v2.SimulateTransactionRequest.TransactionChecks checks = 3;
	 */
 ...
 *
 * @generated from protobuf enum myso.rpc.v2.SimulateTransactionRequest.TransactionChecks
 */
...
/**
 * @generated from protobuf message myso.rpc.v2.SimulateTransactionResponse
 */
export interface SimulateTransactionResponse {
	...
	transaction?: ExecutedTransaction;
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.CommandResult command_outputs = 2;
	 */
 ...
 *
 * @generated from protobuf message myso.rpc.v2.CommandResult
 */
export interface CommandResult {
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.CommandOutput return_values = 1;
	 */
	returnValues: CommandOutput[];
	/**
	 * @generated from protobuf field: repeated myso.rpc.v2.CommandOutput mutated_by_ref = 2;
	 */
	mutatedByRef: CommandOutput[];
}
/**
 * @generated from protobuf message myso.rpc.v2.CommandOutput
 */
export interface CommandOutput {
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Argument argument = 1;
	 */
	argument?: Argument;
	/**
	 * @generated from protobuf field: optional myso.rpc.v2.Bcs value = 2;
	 */
	value?: Bcs;
	/**
...
class ExecuteTransactionRequest$Type extends MessageType<ExecuteTransactionRequest> {
	constructor() {
		super('myso.rpc.v2.ExecuteTransactionRequest', [
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ExecuteTransactionRequest
 */
...
class ExecuteTransactionResponse$Type extends MessageType<ExecuteTransactionResponse> {
	constructor() {
		super('myso.rpc.v2.ExecuteTransactionResponse', [
			{ no: 1, name: 'transaction', kind: 'message', T: () => ExecutedTransaction },
		]);
	}
}
/**
 * @generated MessageType for protobuf message myso.rpc.v2.ExecuteTransactionResponse
 */
...
class SimulateTransactionRequest$Type extends MessageType<SimulateTransactionRequest> {
	constructor() {
		super('myso.rpc.v2.SimulateTransactionRequest', [
			{ no: 1, name: 'transaction', kind: 'message', T: () => Transaction },
			{ no: 2, name: 'read_mask', kind: 'message', T: () => FieldMask },
			{
				...
				opt: true,
				T: () => [
					'myso.rpc.v2.SimulateTransactionRequest.TransactionChecks',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.SimulateTransactionRequest
 */
...
class SimulateTransactionResponse$Type extends MessageType<SimulateTransactionResponse> {
	constructor() {
		super('myso.rpc.v2.SimulateTransactionResponse', [
			{ no: 1, name: 'transaction', kind: 'message', T: () => ExecutedTransaction },
			{
				no: 2,
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.SimulateTransactionResponse
 */
...
class CommandResult$Type extends MessageType<CommandResult> {
	constructor() {
		super('myso.rpc.v2.CommandResult', [
			{
				no: 1,
				name: 'return_values',
				kind: 'message',
...
/**
 * @generated MessageType for protobuf message myso.rpc.v2.CommandOutput
 */
export const CommandOutput = new CommandOutput$Type();
/**
 * @generated ServiceType for protobuf service myso.rpc.v2.TransactionExecutionService
 */
