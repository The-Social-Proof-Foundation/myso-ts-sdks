...
export type EpochInfo = {
	epoch: string;
	validators: MySoValidatorSummary[];
...
export type MySoMoveNormalizedModules = Record<string, MySoMoveNormalizedModule>;

export type MySoMoveObject = Extract<MySoParsedData, { dataType: 'moveObject' }>;
export type MySoMovePackage = Extract<MySoParsedData, { dataType: 'package' }>;
