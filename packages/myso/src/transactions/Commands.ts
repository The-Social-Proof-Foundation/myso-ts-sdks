...
import { normalizeMySoObjectId } from '../utils/myso-types.js';
...
// crates/myso-framework/packages/myso-framework/sources/package.move
	...
	Publish({
		...
		return {
			...
			Publish: {
				...
				dependencies: dependencies.map((dep) => normalizeMySoObjectId(dep)),
			},
		};
	},
	Upgrade({
