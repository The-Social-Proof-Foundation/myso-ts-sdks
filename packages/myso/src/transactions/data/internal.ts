...
import { isValidMySoAddress, normalizeMySoAddress } from '../../utils/myso-types.js';
...
export const MySoAddress = pipe(
	string(),
	transform((value) => normalizeMySoAddress(value)),
	check(isValidMySoAddress),
);
export const ObjectID = MySoAddress;
...
// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/base_types.rs#L138
// Implemented as a tuple in rust
export const ObjectRefSchema = object({
	objectId: MySoAddress,
	version: JsonU64,
	digest: string(),
});
export type ObjectRef = InferOutput<typeof ObjectRefSchema>;

// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/transaction.rs#L690-L702
...
// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/transaction.rs#L1387-L1392
export const GasDataSchema = object({
	budget: nullable(JsonU64),
	price: nullable(JsonU64),
	owner: nullable(MySoAddress),
	payment: nullable(array(ObjectRefSchema)),
});
export type GasData = InferOutput<typeof GasDataSchema>;

// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/external-crates/move/crates/move-core-types/src/language_storage.rs#L140-L147
...
export const OpenSignatureBodySchema: GenericSchema<MySoClientTypes.OpenSignatureBody> = union([
...
// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/transaction.rs#L707-L718
...
// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/transaction.rs#L657-L685
...
export type Command<Arg = Argument> = EnumOutputShape<{
	MoveCall: {
		...
		arguments: Arg[];
		_argumentTypes?: MySoClientTypes.OpenSignature[] | null;
	};
	TransferObjects: {
		objects: Arg[];
		address: Arg;
...
// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/transaction.rs#L102-L114
...
// Rust: crates/myso-types/src/transaction.rs
...
// https://github.com/the-social-proof-foundation/myso-core/blob/df41d5fa8127634ff4285671a01ead00e519f806/crates/myso-types/src/transaction.rs#L75-L80
