...
import { MySoTransactionBlockResponse } from '../../../../src/jsonRpc/index.js';
import { Transaction } from '../../../../src/transactions/index.js';
import { executePayMySoNTimes, setup, TestToolbox } from '../../utils/setup.js';

describe('Transaction Reading API', () => {
	let toolbox: TestToolbox;
	let transactions: MySoTransactionBlockResponse[];
	const NUM_TRANSACTIONS = 10;

	beforeAll(async () => {
		toolbox = await setup();
		transactions = await executePayMySoNTimes(
