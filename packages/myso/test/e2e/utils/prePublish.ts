...
import { requestMySoFromFaucetV2, FaucetRateLimitError } from '../../../src/faucet/index.js';
import { Transaction } from '../../../src/transactions/index.js';
import { normalizeMySoAddress } from '../../../src/utils/index.js';
import { MySoGrpcClient } from '../../../src/grpc/client.js';
...
async function publishSinglePackage(options: {
	...
	const packageId = normalizeMySoAddress(publishedChange.objectId);
