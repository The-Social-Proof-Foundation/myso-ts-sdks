...
import { Input_InputKind } from '../../../src/grpc/proto/myso/rpc/v2/input.js';
import { Argument_ArgumentKind } from '../../../src/grpc/proto/myso/rpc/v2/argument.js';
import type { Transaction as GrpcTransaction } from '../../../src/grpc/proto/myso/rpc/v2/transaction.js';
	...
	describe('Command Conversion', () => {
		...
		it('should convert MakeMoveVector commands correctly', () => {
			...
			if (command?.command?.oneofKind === 'makeMoveVector') {
				expect(command.command.makeMoveVector.elementType).toBe('0x2::coin::Coin<0x2::myso::MYSO>');
