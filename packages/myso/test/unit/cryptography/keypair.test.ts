...
describe('Keypair', () => {
	...
	it('`toMySoAddress()` should return a valid myso address', async () => {
		expect(k1.toMySoAddress()).toEqual(pk1.toMySoAddress());
		expect(k1.toMySoAddress()).toEqual(
			'0xafedf3bc60bd296aa6830d7c48ca44e0f7a32478ae4bd7b9a6ac1dc81ff7b29b',
		);

		expect(k2.toMySoAddress()).toEqual(pk2.toMySoAddress());
		expect(k2.toMySoAddress()).toEqual(
			'0x7e4f9a35bf3b5383802d990956d6f3c93e6184ebbbcf0820c124ab3a59ef77ac',
		);

		expect(k3.toMySoAddress()).toEqual(pk3.toMySoAddress());
