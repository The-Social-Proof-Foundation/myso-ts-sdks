...
describe('parseFromStr', () => {
	it('parses nested struct type from a string', () => {
		const typeStr =
			'0x2::balance::Supply<0x72de5feb63c0ab6ed1cda7e5b367f3d0a999add7::amm::LP<0x2::myso::MYSO, 0xfee024a3c0c03ada5cdbda7d0e8b68802e6dec80::example_coin::EXAMPLE_COIN>>';
