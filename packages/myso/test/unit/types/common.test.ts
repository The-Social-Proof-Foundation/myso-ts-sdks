...
import { normalizeStructTag, parseStructTag } from '../../../src/utils/myso-types.js';
...
describe('parseStructTag', () => {
    ...
    `);
		...
		expect(parseStructTag('@mvr/demo::foo::bar<inner.mvr.myso/demo::baz::qux, bool>'))
			.toMatchInlineSnapshot(`
      {
        "address": "@mvr/demo",
        "module": "foo",
...
describe('normalizeStructTag', () => {
	...
	it('normalizes named package addresses', () => {
		const checks = [
			'@mvr/demo::foo::bar<inner.mvr.myso/demo::baz::qux,bool>',
			'@mvr/demo::foo::bar',
			'@mvr/demo::foo::bar<inner.mvr.myso/demo::baz::Qux,bool,inner@mvr/demo::foo::Nested<u64,bool>>',
		];
