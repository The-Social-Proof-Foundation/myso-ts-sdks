...
import * as bag from './deps/myso/bag.js';
import * as vec_set from './deps/myso/vec_set.js';
import * as type_name from './deps/std/type_name.js';
const $moduleName = '@orderbook/core::balance_manager';
...
export const OrderbookReferral = new MoveStruct({
	name: `${$moduleName}::OrderbookReferral`,
	fields: {
		id: bcs.Address,
		owner: bcs.Address,
	},
});
export const OrderbookPoolReferral = new MoveStruct({
	name: `${$moduleName}::OrderbookPoolReferral`,
	fields: {
		id: bcs.Address,
		owner: bcs.Address,
		pool_id: bcs.Address,
...
export const OrderbookReferralCreatedEvent = new MoveStruct({
	name: `${$moduleName}::OrderbookReferralCreatedEvent`,
	fields: {
		referral_id: bcs.Address,
		owner: bcs.Address,
	},
});
export const OrderbookReferralSetEvent = new MoveStruct({
	name: `${$moduleName}::OrderbookReferralSetEvent`,
	fields: {
		referral_id: bcs.Address,
		balance_manager_id: bcs.Address,
	},
...
export interface NewWithCustomOwnerCapsArguments {
	orderbookRegistry: RawTransactionArgument<string>;
	owner: RawTransactionArgument<string>;
}
export interface NewWithCustomOwnerCapsOptions {
	...
	arguments:
		...
		| [orderbookRegistry: RawTransactionArgument<string>, owner: RawTransactionArgument<string>];
	typeArguments: [string];
}
export function newWithCustomOwnerCaps(options: NewWithCustomOwnerCapsOptions) {
	const packageAddress = options.package ?? '@orderbook/core';
	const argumentsTypes = [null, 'address'] satisfies (string | null)[];
	const parameterNames = ['orderbookRegistry', 'owner'];
	return (tx: Transaction) =>
		tx.moveCall({
			package: packageAddress,
			module: 'balance_manager',
