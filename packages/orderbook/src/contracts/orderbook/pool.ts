...
import * as versioned from './deps/myso/versioned.js';
...
export interface UpdateOrderbookReferralMultiplierArguments {
	Self: RawTransactionArgument<string>;
	Referral: RawTransactionArgument<string>;
	Multiplier: RawTransactionArgument<number | bigint>;
}
export interface UpdateOrderbookReferralMultiplierOptions {
	package?: string;
	arguments:
		| UpdateOrderbookReferralMultiplierArguments
		| [
				Self: RawTransactionArgument<string>,
				Referral: RawTransactionArgument<string>,
				Multiplier: RawTransactionArgument<number | bigint>,
...
export function updateOrderbookReferralMultiplier(options: UpdateOrderbookReferralMultiplierOptions) {
	const packageAddress = options.package ?? '@orderbook/core';
	const argumentsTypes = [null, null, 'u64'] satisfies (string | null)[];
	const parameterNames = ['Self', 'Referral', 'Multiplier'];
	return (tx: Transaction) =>
