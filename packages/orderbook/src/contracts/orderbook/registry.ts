...
const $moduleName = '@orderbook/core::registry';
...
export const OrderbookAdminCap = new MoveStruct({
	name: `${$moduleName}::OrderbookAdminCap`,
	fields: {
		id: bcs.Address,
	},
});
 ...
 * treasury address is the publisher of the orderbook package
 */
