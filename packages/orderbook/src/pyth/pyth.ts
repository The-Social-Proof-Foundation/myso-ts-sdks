...
import { fromBase64, fromHex, parseStructTag } from '@socialproof/myso/utils';
...
export class MySoPriceServiceConnection extends PriceServiceConnection {
	/**
