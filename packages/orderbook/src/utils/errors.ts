...
/**
 * @description Base class for Orderbook errors
 */
 ...
 */
export class ResourceNotFoundError extends OrderbookError {
 ...
 */
export class ConfigurationError extends OrderbookError {
	constructor(message: string) {
		super(message);
...
export const ErrorMessages = {
	...
	INVALID_ADDRESS: 'Address must be a valid MySo address',
} as const;
