...
import { MYSO_TYPE_ARG, normalizeStructTag } from '@socialproof/myso/utils';
...
export const MYSO_COIN_TYPE = normalizeStructTag(MYSO_TYPE_ARG);
export const DEFAULT_REGISTRY_NAME = 'default-payment-registry';

export const MYSO_PAYMENT_KIT_PROTOCOL = 'myso:pay';
